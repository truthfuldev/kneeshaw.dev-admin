...
export default function CreateGame() {
  ...
  return (
    <div className="flex flex-col justify-center gap-[15px] rounded-xl p-[20px]">
      <p className="mb-[50px] text-[60px] text-black">Create One</p>
      <input
        type="text"
        placeholder="Input Image"
        name="image"
        className="h-[52px] w-full rounded-[16px] border-[1px] bg-transparent pl-[10px] "
      ...
      />
      <button
        className="h-[52px] w-full rounded-[16px] border-[1px] border-black bg-transparent text-black"
